...
% find . -type f -name "*.tex" -exec sed -i 's/Versão: 0.1 - 2020-03-27/Versão: 0.4 - 2022-08-19/g' {} +
%
...
% ------------------------------------------------------------------------------
% ------------------------------------------------------------------------------
\include{20222-CODDISC-SEC01-PROFESSOR}

\include{20222-CODDISC-SEC02-PLANO}

\include{20222-CODDISC-SEC03-PLANEJAMENTO}

\include{20222-CODDISC-SEC04-INTRODUCAO}

\include{20222-CODDISC-SEC05-TEMA01}

\include{20222-CODDISC-SEC06-TEMA02}

\include{20222-CODDISC-SEC07-TEMA03}

\include{20222-CODDISC-SEC08-TEMA04}

\include{20222-CODDISC-SEC09-TEMA05}

\include{20222-CODDISC-SEC10-LISTAS}

\include{20222-CODDISC-SEC11-SEMINARIOS}

\include{20222-CODDISC-SEC12-PROJETOS}
