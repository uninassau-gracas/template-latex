...
% ------------------------------------------------------------------------------
% ------------------------------------------------------------------------------
\subsection[Lista de Exercícios 01]{Lista de Exercícios 01}\label{subsec:listas-lista01}



% \begin{frame}[allowframebreaks,t]\frametitle{Lista de Exercícios 01 ---}
...
% \begin{frame}[allowframebreaks,t]\frametitle{Lista de Exercícios 02 ---}
