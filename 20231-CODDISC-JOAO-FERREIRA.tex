...
% find . -type f -name "*.tex" -exec sed -i 's/Versão: 0.1 - 2020-03-27/Versão: 0.4.3 - 2023-02-04/g' {} +
%
...
%\title[\iddisciplina]{\textbf{\disciplina}}
\title[\curso]{\curso}
...
{\usebackgroundtemplate{{\transparent{0.1}\includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{img/logo/background-amarelo.png}}}
  \begin{frame}[plain,t]
...
% ------------------------------------------------------------------------------
% ------------------------------------------------------------------------------
\include{20231-CODDISC-SEC01-PROFESSOR}

\include{20231-CODDISC-SEC02-PLANO}

\include{20231-CODDISC-SEC03-PLANEJAMENTO}

\include{20231-CODDISC-SEC04-INTRODUCAO}

\include{20231-CODDISC-SEC05-TEMA01}

\include{20231-CODDISC-SEC06-TEMA02}

\include{20231-CODDISC-SEC07-TEMA03}

\include{20231-CODDISC-SEC08-TEMA04}

\include{20231-CODDISC-SEC09-TEMA05}

\include{20231-CODDISC-SEC10-LISTAS}

\include{20231-CODDISC-SEC11-SEMINARIOS}

\include{20231-CODDISC-SEC12-PROJETOS}
