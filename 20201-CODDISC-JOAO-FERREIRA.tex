...
\def\idcurso{31}
\def\curso{Curso Superior de Tecnologia em Análise e Desenvolvimento de Sistemas}
...
{\usebackgroundtemplate{{\transparent{0.5}\includegraphics[width=\paperwidth,height=\paperheight,keepaspectratio]{img/logo/background-amarelo.png}}}
  \begin{frame}[plain,t]
    ...
    \begin{block}{}
      \centering{}
      \vspace*{2em}
      \huge{\textbf{\MakeUppercase{\disciplina}}}

      \small{\textbf{\MakeUppercase{\professor}}}
      \vspace*{2em}
    \end{block}
...
\include{20201-CODDISC-SEC02-EMENTA}

\include{20201-CODDISC-SEC03-PLANEJAMENTO}

\include{20201-CODDISC-SEC04-AULA01}

\include{20201-CODDISC-SEC05-AULA02}

\include{20201-CODDISC-SEC06-LISTA01}

\include{20201-CODDISC-SEC07-AULA03}

\include{20201-CODDISC-SEC08-AULA04}

\include{20201-CODDISC-SEC09-LISTA02}
